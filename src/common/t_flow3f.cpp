...
TEST(function_call_operator){
    ...
    ASSERT_EQUAL(vector(0), 1.0f);
    ASSERT_EQUAL(vector(1), 2.0f);
    ASSERT_EQUAL(vector(2), 3.0f);
    ASSERT_EQUAL(vector(3), 0.05f);
    ASSERT_EQUAL(vector(4), 0.06f);
    ASSERT_EQUAL(vector(5), 0.08f);
